        ...
        <div className="flex flex-col justify-center items-center">
          ...
          <div className="flex flex-col gap-10 pt-25">
            <div className="flex flex-col justify-center items-center gap-2">
              ...
              <input
                type="text"
                className="w-85 h-15 border border-green-400 rounded text-2xl px-4 text-center focus:outline-none"
                placeholder="김황석"
                value={name}
            ...
            <div className="flex flex-col justify-center items-center gap-2">
              ...
              <textarea
                type="text"
                className="w-85 h-50 border border-green-400 rounded text-xl p-4 focus:outline-none"
